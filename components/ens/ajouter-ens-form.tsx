...
import { enseignantSchemaInterface } from "@/schemas";
import {
  Form,
  FormControl,
  FormField,
...
import { addEnseignant } from "@/actions/add-enseignant";
import { toast } from "sonner";

export const AjouterModel = ({ specialites, grades }: AjouterModelProps) => {
