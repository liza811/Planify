...
const HomePage = () => {
  return (
    ...
    >
      ...
      <Section id="hero" className="  flex justify-center py-0 lg:-mt-4">
        <article
     ...
     gap-x-2
      ...
      "
        ...
        "
            />
            <div className="bg-custom-gradient2 p-[1px] w-fit  h-fit  rounded-[0.5rem] flex items-center justify-center mt-1 lg:ml-3">
        ...
        "
              />
              <p
                className=" w-full text-[15px] md:text-[1rem] mt-5 md:mt-3 text-[#fb4b87] max-w-[400px] mb-7 font-bold
      ...
      <Section
        crosses
        className=" lg:py-32 py-10 md:pt-36 px-14 md:pr-[40px] w-full relative "
        crossesOffset="lg:translate-y-[5.25rem]"
        customPaddings
        id="hero"
      >
        <BottomLine classname="top-[5.25rem]" />
        <div className="md:container lg:flex">
          <div className="md:max-w-[25rem] ">
            <h2 className="text-[1.5rem] text-white -ml-8 md:-ml-0 leading-[2.5rem] px-0 mx-0 md:text-[2rem] md:leading-[2.5rem] lg:text-[2.5rem] lg:leading-[3.5rem] xl:text-[3rem] xl:leading-tight mb-4 md:mb-8 font-medium ">
              Génération Automatique des Plannings
            </h2>

            <ul className="max-w-[22rem] mb-10 md:mb-14 -ml-4 md:-ml-0">
            ...
            <Buttonn
              href={"/login"}
              className={"px-7 -ml-4 md:-ml-0 mb-5 lg:mb-0 text-n-1"}
            >
              Essayez maintenant
            </Buttonn>
          </div>

          <div className="lg:ml-auto xl:w-[38rem] mt-1 w-full">
            <p className="body-2 mb-8 text-n-3 md:mb-16 lg:mb-32 lg:w-[22rem] -ml-8 md:-ml-0 w-[20rem] lg:mx-auto">
